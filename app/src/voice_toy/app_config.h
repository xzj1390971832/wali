...
#define UART_OUTPUT_CH_PORT			IO_PORTB_08
/*---------KEY Configuration---------------*/
//AD KEY
...
#define X_ADC_CH_SEL 				{ADC_CH_PA6,ADC_CH_PA5,ADC_CH_PA4,ADC_CH_PA3}
///Y轴 io 要求是普通IO口
#define Y_PORT_SEL 					{IO_PORTA_02,IO_PORTA_01,IO_PORTA_00}
#define MATRIX_KEY_THRESHOLD_SET	300
//TOUCH KEY
#define TOUCH_KEY_SEL				{IO_PORTB_06}

/*---------KEY VOICE Configuration---------------*/
#define KEY_VOICE_EN   				0

/*---------power wakeup io---------------*/
#define POWER_WAKEUP_IO				IO_PORTB_11
