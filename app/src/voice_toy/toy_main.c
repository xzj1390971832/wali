...
*/
    ...
    while (1) {
        ...
        if(time_cnt == 1 && gpio_read(IO_PORTA_01) == 1){
            gpio_write(IO_PORTA_00,0);
            time_cnt = 0;
        }
