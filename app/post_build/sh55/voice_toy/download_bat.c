...
cd voice_toy
isd_download.exe -tonorflash -dev sh55 -boot 0x0 -div8 -wait 300 -uboot uboot.boot  -uboot_compress -app app.bin 0x20000 -res dir_a dir_song
@rem isd_download.exe -tonorflash -dev sh55 -boot 0x0 -div8 -wait 300 -uboot uboot.boot  -uboot_compress -app app.bin 0x20000 -res dir_a dir_song -wflash dir_song 0 [PA05_1B_NULL]
